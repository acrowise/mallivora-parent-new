...
public final class ProposalPackage {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getPayloadVisibility()
          .equals(other.getPayloadVisibility())) return false;
  ...
  public interface ChaincodeActionOrBuilder extends
     ...
     * </pre>
     *
     * <code>.protos.TokenExpectation token_expectation = 5;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (hasTokenExpectation() != other.hasTokenExpectation()) return false;
      if (hasTokenExpectation()) {
        if (!getTokenExpectation()
            .equals(other.getTokenExpectation())) return false;
      }
      if (!unknownFields.equals(other.unknownFields)) return false;
      return true;
    }
